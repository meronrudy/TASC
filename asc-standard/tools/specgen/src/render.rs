...
pub fn render_thresholds(
    ...
    format!(
        "// @generated by tools/specgen. DO NOT EDIT.\n\npub const FRAME: &str = \"{}\";\npub const MAX_SPEED_MPS: f64 = {:?};\npub const MAX_BANK_DEG: f64 = {:?};\npub const ATTITUDE_LIMIT_DEG: f64 = {:?};\npub const MIN_ALTITUDE_M: f64 = {:?};\npub const POSITION_MIN_X_M: f64 = {:?};\npub const POSITION_MIN_Y_M: f64 = {:?};\npub const POSITION_MIN_Z_M: f64 = {:?};\npub const POSITION_MAX_X_M: f64 = {:?};\npub const POSITION_MAX_Y_M: f64 = {:?};\npub const POSITION_MAX_Z_M: f64 = {:?};\npub const MIN_SOC_PERCENT: f64 = {:?};\npub const MAX_INPUT_AGE_MS: u64 = {};\npub const MAX_TICK_INTERVAL_MS: u64 = {};\npub const DEADLINE_MS: u64 = {};\npub const MAX_ROLL_RATE_DPS: f64 = {:?};\npub const MAX_PITCH_RATE_DPS: f64 = {:?};\npub const MAX_YAW_RATE_DPS: f64 = {:?};\npub const MAX_CLIMB_RATE_MPS: f64 = {:?};\n",
        state.frame,
        state.max_speed_mps,
        inv.max_bank_deg,
        state.attitude_limit_deg,
        inv.min_altitude_m,
        state.position_bounds_m.min[0],
        state.position_bounds_m.min[1],
        state.position_bounds_m.min[2],
        state.position_bounds_m.max[0],
        state.position_bounds_m.max[1],
        state.position_bounds_m.max[2],
